<?php
ob_start();
// views/contact/client/index.php – Gestion des clients (design vente)
...
$types_contact = ['Client']; // seulement Client
                ...
                try {
                    if ($action === 'add') {
                        ...
                        if ($stmt->fetchColumn() > 0) {
                            ...
                            $message = "Client « $nom » ajouté avec succès. ID : $code";
                            $messageType = 'success';
                        }
                    } elseif ($action === 'edit') {
...
<div class="W">
    ...
    <div class="hdr">
        ...
        <div class="hdr-r">
            <div class="hdr-badge"><i class="bi bi-people"></i> <?= $initialData['total'] ?? 0 ?> clients</div>
            <button class="btn-go" id="addBtn"><i class="bi bi-plus-circle"></i> Nouveau client</button>
        </div>
    </div>
    ...
    <div class="data-table-wrap" id="tableWrapper">
        <div class="d-flex flex-wrap align-items-center justify-content-between p-3 border-bottom bg-light">
            <h5 class="mb-0 fw-bold" style="font-family:'Outfit',sans-serif;">Liste des clients</h5>
            <span class="text-muted small" id="totalCount"><?= $initialData['total'] ?> client(s) - Page <?= $initialData['page'] ?> / <?= max(1, $initialData['totalPages']) ?></span>
        </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title fw-bold" id="modalTitle"><i class="bi bi-people-fill text-primary me-2"></i> Nouveau client</h5>
            ...
            <form method="post" id="contactForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            <label for="code_contact" class="form-label fw-semibold">Code client</label>
                    ...
                    <input type="hidden" name="type_contact" value="Client">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content border-0 shadow" style="border-radius: 16px;">
            <div class="modal-body text-center p-4">
                ...
                <p class="text-danger mb-4">Êtes-vous sûr de vouloir supprimer le client <strong id="deleteNomContact"></strong> ?<br>Cette action est irréversible.</p>
...
$(document).ready(function() {
    ...
    $('#addBtn').on('click', function(e) {
        ...
        $('#formAction').val('add');
        $('#oldCode').val('');
        $('#modalTitle').html('<i class="bi bi-people-fill text-primary me-2"></i> Nouveau client');
        $('#contactForm')[0].reset();
    ...
    function rechercher(page) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#totalCount').text(data.total + ' client(s) - Page ' + data.page + ' / ' + Math.max(1, data.totalPages));
    ...
    <?php if (isset($editContact) && $action === 'load_edit'): ?>
        $(function() {
            ...
            $('#modalTitle').html('<i class="bi bi-people-fill text-primary me-2"></i> Modifier le client');
            $('#code_contact').prop('readonly', true);
            $('.selectpicker').selectpicker('refresh');
            contactModal.show();
        });
