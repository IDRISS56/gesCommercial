...
$page_title = "Factures Fournisseurs";

// Requête de base pour le tableau (pagination manuelle)
$sqlBase = "SELECT f.numero_facture, f.titre_facture, f.date_facture, f.montant_ttc, f.avance, f.reste, f.etat_facture, ct.nom_prenom_contact AS fournisseur
            FROM facture f
...
<div class="W">
    <div class="hdr">
        <div><h1>Factures Fournisseurs</h1><p>Suivi des factures fournisseurs</p></div>
        <div class="header-badge"><i class="bi bi-file-earmark-invoice"></i> <?= $total ?> factures</div>
    </div>

    <div class="report-card">
        <h3><i class="bi bi-list-ul me-2"></i> Liste des factures fournisseurs <span class="text-muted small"><?= $total ?> lignes</span></h3>
        <div class="table-wrapper">
            <table>
                <thead><tr><th>N°</th><th>Fournisseur</th><th>Date</th><th>Montant TTC</th><th>Avance</th><th>Reste</th><th>État</th></tr></thead>
