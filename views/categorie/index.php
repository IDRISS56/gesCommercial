...
<div class="W">
    ...
    <div class="hdr">
        ...
        <div class="hdr-r">
            <div class="hdr-badge"><i class="bi bi-folder"></i> <?= $initialData['total'] ?? 0 ?> catégorie(s)</div>
            <button class="btn-go" id="addBtn"><i class="bi bi-plus-circle"></i> Nouvelle catégorie</button>
        </div>
    </div>
    ...
    <div class="pbar">
        <form id="searchForm" method="post" onsubmit="return false;">
            ...
            <div class="prow">
                ...
                <input type="text" name="search" id="searchInput" placeholder="Code, titre, type..." value="<?= e($search) ?>" style="flex:1; min-width:150px;">
    ...
    <div class="data-table-wrap" id="tableWrapper">
        <div class="d-flex flex-wrap align-items-center justify-content-between p-3 border-bottom bg-light">
            <h5 class="mb-0 fw-bold" style="font-family:'Outfit',sans-serif;">Liste des catégories</h5>
...
$(document).ready(function() {
    ...
    const categorieModal = new bootstrap.Modal(document.getElementById('categorieModal'));
