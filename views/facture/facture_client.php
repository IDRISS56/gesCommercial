...
if (isset($_POST['export_pdf']) && $_POST['export_pdf'] == '1' && !empty($_POST['numero'])) {
    ...
    $pdf->SetTextColor($blueDark[0], $blueDark[1], $blueDark[2]);
    $pdf->Text(52, $ySig + 9, $toLatin($boutique['nom_boutique'] ?? ''));
    $pdf->SetFont('Arial', '', 6);
    $pdf->Text(52, $ySig + 13, $toLatin($boutique['adresse_boutique'] ?? ''));
    $pdf->Text(52, $ySig + 17, $toLatin('Tél. : ' . ($boutique['telephone_boutique'] ?? '')));
...
<div class="W">
    ...
    <div class="hdr">
        ...
        <div class="hdr-r">
            ...
            <button class="btn-go" id="addBtn"><i class="bi bi-plus-circle"></i> Nouvelle facture</button>
        </div>
    </div>
    ...
    <div class="pbar">
        <form id="searchForm" method="post" onsubmit="return false;">
            ...
            <div class="prow">
                ...
                <select name="contact_filter" id="contactFilter" class="selectpicker" data-live-search="true" data-live-search-placeholder="Rechercher un contact...">
